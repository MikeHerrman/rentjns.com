...
const rentals = [
  {
    ...
    sqft: 1300,
    pets: false,
    blurb: `Escape to the beach and relax at our Coastal Cottage. This home offers a spacious open living area with fully stocked kitchen. Enjoy three cozy bedrooms, roomy full bathroom and large private yard. Just 1 mile to the beach, 3 miles to Quinault Casino, 4 miles to Ocean Shores and a 20 min drive to Seabrook. Whether you stay in or venture out, you'll find everything you need here for relaxation and fun!`,
    gallery: [
      'deck-1a.jpg',
      'living-1a.jpg',
      'living-1b.jpg',
  ...
  },
  {
    ...
    pets: false,
    blurb:
      'If you want a relaxing getaway near the beach, stay at the Shore Bird Chalet.  This fully stocked, cozy little home has everything you need to unwind, refresh and have fun. Located in a quiet little neighborhood with lots of wildlife.  Just five minutes to Ocean Shores and to the beach, and one mile from Quinault, Casino',
    gallery: [
      'home-1.jpg',
      'home-2.jpg',
      'from-entry.jpg',
  ...
  },
  {
    ...
    slug: 'property-3',
    name: 'Property 3',
    img: '/assets/images/rentals/property-3.png',
  ...
  },
  {
    ...
    slug: 'property-4',
    name: 'Property 4',
    img: '/assets/images/rentals/property-4.png',
